...
public class CustomersScreenController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     public void loadAllCustomers(String sql) {
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> id = new com.jfoenix.controls.JFXTreeTableColumn<>("Id");
        id.setPrefWidth(70);
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> name = new com.jfoenix.controls.JFXTreeTableColumn<>("Name");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> email = new com.jfoenix.controls.JFXTreeTableColumn<>("Email");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> address = new com.jfoenix.controls.JFXTreeTableColumn<>("Adress");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> phone = new com.jfoenix.controls.JFXTreeTableColumn<>("Phone");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> numOfPeople = new com.jfoenix.controls.JFXTreeTableColumn<>("Number of People");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> payment = new com.jfoenix.controls.JFXTreeTableColumn<>("Payment Type");
        ...
        payment.setCellValueFactory(new Callback<TreeTableColumn.CellDataFeatures<Customer, String>, ObservableValue<String>>() {
          ...
          com.jfoenix.controls.JFXTreeTableColumn<Customer, String> duration = new com.jfoenix.controls.JFXTreeTableColumn<>("Duration");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> roomType = new com.jfoenix.controls.JFXTreeTableColumn<>("Room Type");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> roomNumber = new com.jfoenix.controls.JFXTreeTableColumn<>("Room Number");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> start = new com.jfoenix.controls.JFXTreeTableColumn<>("Start Date");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> end = new com.jfoenix.controls.JFXTreeTableColumn<>("End Date");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> price = new com.jfoenix.controls.JFXTreeTableColumn<>("Price");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> services = new com.jfoenix.controls.JFXTreeTableColumn<>("Services");
        ...
        com.jfoenix.controls.JFXTreeTableColumn<Customer, String> total = new com.jfoenix.controls.JFXTreeTableColumn<>("Total");
        ...
        final TreeItem<Customer> root = new RecursiveTreeItem<>(customer, RecursiveTreeObject::getChildren);
